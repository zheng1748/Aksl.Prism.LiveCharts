...
using Aksl.Modules.LiveCharts.Scatter.ViewModels;
using Aksl.Modules.LiveCharts.Scatter.Views;

//install-package LiveChartsCore.SkiaSharpView.WPF -Version 2.0.0-beta.90

namespace Aksl.Modules.LiveCharts.Scatter
{
    public class ScatterModule : IModule
    {
        #region Members
        ...
        #region Constructors
        public ScatterModule(IUnityContainer container)
        {
