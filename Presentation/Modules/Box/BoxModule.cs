...
namespace Aksl.Modules.LiveCharts.Box
{
    public class BoxModule : IModule
    {
        ...
        {
            containerRegistry.RegisterForNavigation<BoxBasicView>();
        }

        public void OnInitialized(IContainerProvider containerProvider)
        {
            ViewModelLocationProvider.Register(typeof(BoxBasicView).ToString(),
                                        () => this._container.Resolve<BoxBasicViewModel>());
        }
        #endregion
    }
}
