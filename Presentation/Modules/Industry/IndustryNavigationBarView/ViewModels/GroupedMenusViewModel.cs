...
namespace Aksl.Modules.IndustryNavigationBar.ViewModels
{
    public class GroupedMenusViewModel : BindableBase
    {
        ...
        #region Constructors
        public GroupedMenusViewModel(IEventAggregator eventAggregator,MenuItem rootMenuItem)
        {
        ...
        internal void CreateGroupedMenuViewModels()
        {
            IsLoading = true;

            int index = 0;
            foreach (var smi in _rootMenuItem.SubMenus)
            {
