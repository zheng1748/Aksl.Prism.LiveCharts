...
namespace Aksl.Wpf.Unity
{
    ...
    public partial class App
    {
        ...
        protected async Task RegisterMenuFactoryAsync(IContainerRegistry containerRegistry)
        {
            try
            {
                MenuService menuService = new (new List<string> {"pack://application:,,,/Aksl.LiveCharts;Component/Data/AllMenus.xml",
                                                                 "pack://application:,,,/Aksl.LiveCharts;Component/Data/Axes.xml",
                                                                 "pack://application:,,,/Aksl.LiveCharts;Component/Data/Bars.xml",
                                                                 "pack://application:,,,/Aksl.LiveCharts;Component/Data/Box.xml",
                                                                 "pack://application:,,,/Aksl.LiveCharts;Component/Data/Design.xml",
                                                                 "pack://application:,,,/Aksl.LiveCharts;Component/Data/Error.xml",
                                                                 "pack://application:,,,/Aksl.LiveCharts;Component/Data/Events.xml"
                                                                 });
